...
const tiers = [
  {
    ...
    perEmployee: "~$0.35",
    icon: Users,
    features: ["Up to 25 active logins", "Admin dashboard", "Bucks tracking", "Basic reporting", "Email support"],
  },
  {
    id: "mid" as const,
    name: "Mid-Size Site",
    ...
    icon: Building2,
    popular: true,
    features: ["Up to 75 active logins", "Admin dashboard", "Bucks tracking", "Advanced reporting", "Priority support"],
  },
  {
    id: "large" as const,
    name: "Large Site",
    ...
    perEmployee: "~$0.16",
    icon: Zap,
    features: ["Up to 150 active logins", "Admin dashboard", "Bucks tracking", "Advanced reporting", "Priority support"],
  },
  {
